...
namespace MvcNetCorePaginacionRegistros.Repositories
{
    ...
    */
    ...
    public class RepositoryHospital
    {
        ...
        public async Task<ModelEmpleadosOficio> GetEmpleadosOficioOutAsync
        ...
        public async Task<int> GetEmpleadosOficioCountAsync
            (string oficio)
        {
        ...
        public async Task<List<Departamento>> GetGrupoDepartamentosAsync
            (int posicion)
        {
        ...
        public async Task<List<VistaDepartamento>> GetGrupoVistaDepartamentosAsync
            (int posicion)
        {
        ...
        public async Task<VistaDepartamento> GetVistaDepartamentoAsync
            (int posicion)
        {
