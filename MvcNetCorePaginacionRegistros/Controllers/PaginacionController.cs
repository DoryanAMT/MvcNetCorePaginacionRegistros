...
namespace MvcNetCorePaginacionRegistros.Controllers
{
    public class PaginacionController : Controller
    {
        ...
        public async Task<IActionResult> PaginarGrupoEmpleados
            (int? posicion)
        {
            if (posicion == null)
            {
        ...
        public async Task<IActionResult> PaginarGrupoDepartamentos
            (int? posicion)
        {
            if (posicion == null)
            {
        ...
        public async Task<IActionResult> PaginarGrupoVistaDepartamento
            (int? posicion)
        {
            if (posicion == null)
            {
        ...
        public async Task<IActionResult> PaginarRegistroVistaDepartamento
            (int? posicion)
        {
            if (posicion == null)
            {
